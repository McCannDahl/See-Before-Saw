...
public class Calendar : MonoBehaviour {
	...
	void setupCells() {
		yearPanel.setupCells (selectedDate, activePanel);
		monthPanel.setupCells (selectedDate, activePanel);
		dayPanel.setupCells (selectedDate, activePanel);
		weekdayPanel.setupCells (selectedDate, activePanel);
	}
	...
	void setSelectedDateText() {
		...
		projectController.CompleteTask(ProjectTasks.timelineSet);
	}
